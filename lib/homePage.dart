    ...
    return Drawer(
      child: ListView(
        children: <Widget>[
          ...
          buildListTile(
              "About Nazir Care Foundation", FontAwesomeIcons.leaf, 6),
      ...
      onTap: () async => {
        index == 7
            ? await FlutterShare.share(
                title:
                    'Help The Needy People Give Your Zakaat,Sadqa and Other Donations through Nazir Care Foundation..we care',
                text:
                    'Help The Needy People Give Your Zakaat,Sadqa and Other Donations through Nazir Care Foundation..we care',
